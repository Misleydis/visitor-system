...
const styles = StyleSheet.create({
  ...
  reportBtn: { flexDirection: 'row', backgroundColor: '#3498db', padding: 15, margin: 10, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
  reportBtnSecondary: { backgroundColor: '#2ecc71' },
  reportBtnText: { color: '#fff', fontWeight: 'bold', marginLeft: 10, fontSize: 16 },
