  ...
  return (
    ...
    >
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Pending Approvals {pendingUsers.length > 0 && `(${pendingUsers.length})`}</Text>
          ...
          pendingUsers.map(user => (
            <View key={user._id} style={styles.pendingRow}>
              ...
              <View style={styles.approveButtons}>
                ...
                <TouchableOpacity style={[styles.approveBtn, { backgroundColor: '#3498db' }]} onPress={() => handleApprove(user._id, 'admin')}>
                  <Text style={styles.approveText}>Admin</Text>
                </TouchableOpacity>
              </View>
            </View>
          ))
...
const styles = StyleSheet.create({
  ...
  approveButtons: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'flex-end' },
