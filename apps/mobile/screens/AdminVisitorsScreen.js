...
export default function AdminVisitorsScreen({ navigation, hideHeader }) {
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#f0f4f8', paddingHorizontal: 20, paddingTop: 8 },
  searchContainer: {
    flexDirection: 'row',
    backgroundColor: '#fff',
    marginBottom: 12,
  ...
  scrollView: { flex: 1 },
  visitorCard: { backgroundColor: '#fff', borderRadius: 20, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#e2e8f0' },
