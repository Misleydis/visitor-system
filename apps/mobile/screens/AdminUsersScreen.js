...
export default function AdminUsersScreen({ navigation, hideHeader }) {
...
const styles = StyleSheet.create({
  ...
  addBtn: { flexDirection: 'row', backgroundColor: '#2563eb', padding: 16, marginBottom: 12, borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
  addBtnText: { color: '#fff', fontWeight: 'bold', marginLeft: 10 },
  formCard: { backgroundColor: '#fff', marginBottom: 12, padding: 20, borderRadius: 20, borderWidth: 1, borderColor: '#e2e8f0' },
